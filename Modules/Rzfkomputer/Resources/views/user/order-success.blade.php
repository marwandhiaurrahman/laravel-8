        ...
        <div class="order-success">
            <div class="container">
                <div class="order-success__invoice">
                    <h3 class="order-success__invoice-heading">Terima kasih telah berbelanja di RZF Komputer. Pesanan Anda
                        akan kami proses.</h3>
                ...
                <div class="order-success__confirmation">
                    ...
                    <a class="btn btn--primary btn--confirmation"
                        href="https://api.whatsapp.com/send?phone=6285864772042&amp;text=Saya%20mau%20melakukan%20konfirmasi%20pembayaran.%0A%0ANama%20%3A%20Dendi Budiansyah%0ANama%20Usaha%20%3A%20Dendi Komputer%0AEmail%20%3A%20budidendi1234@gmail.com%0AAlamat%20%3A%20Jl. Raya Suci Desa Cidulang No. 01 Cikijing Kabupaten Majalengka 45466"
                        target="_blank"> Konfirmasi Pembayaran</a>
                    <a class="btn btn--primary btn--confirmation" href="status-pemesanan.html"> Cek Status</a>
                </div>
            </div>
        </div>
        <!-- end-order-success-->
