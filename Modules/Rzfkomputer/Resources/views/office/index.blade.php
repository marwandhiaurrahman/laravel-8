        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tabel Data Office</h3>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['route' => 'office.store', 'method' => 'POST', 'files' => false]) !!}
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="inputName">Nama Office</label>
                        {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'inputName', 'placeholder' => 'Masukan Nama Kantor', 'autofocus', 'required']) !!}
                    </div>
                    <div class="form-group">
