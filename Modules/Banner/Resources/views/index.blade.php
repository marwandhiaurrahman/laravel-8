                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('contact.destroy', $item) }}" method="POST">
                                            <a class="btn btn-xs btn-warning" href="{{ route('contact.edit', $item) }}"
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['route' => 'contact.store', 'method' => 'POST', 'files' => false]) !!}
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'inputName', 'placeholder' => 'Nama Banner', 'autofocus', 'required']) !!}
                    </div>
                    <div class="form-group">
                        <label for="inputLabel">Label</label>
                        {!! Form::text('label', null, ['class' => 'form-control', 'id' => 'inputLabel', 'Label'> 'Masukan Label Banner', 'required']) !!}
                    </div>
                </div>
